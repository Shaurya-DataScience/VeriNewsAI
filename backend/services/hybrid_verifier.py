...
import database
from database import get_system_config, save_to_cache, save_claim_embedding, record_analytics_event
...
async def run_hybrid_verification(query: str) -> Dict[str, Any]:
    ...
    # Calculate real CrossEncoder score for top candidate
    ...
    key_evidence_quotes = [e.get("quote", "") for e in verification_res.get("key_evidence", [])]
